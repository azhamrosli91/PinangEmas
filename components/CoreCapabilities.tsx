                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                    {features.map((feature, i) => (
                        ...
                        >
                            ...
                            <div className="relative card-glass p-12 rounded-[2.5rem] bg-white border-[#AA771C]/10 hover:border-gold/30 h-full transition-all duration-500 flex flex-col items-start">
                                <div className="mb-10 relative">
                                    ...
                                    <div className="relative w-16 h-16 rounded-2xl bg-[#F8F2DF] flex items-center justify-center text-[#AA771C] border border-[#AA771C]/20 group-hover:border-gold/40 group-hover:bg-gold/5 transition-all duration-500">
                                ...
                                <h4 className="text-2xl font-black text-[#101010] mb-4 group-hover:text-gold transition-colors">
                                    {feature.title}
                                </h4>
                                <p className="text-[#101010]/70 text-lg leading-relaxed mb-8 flex-grow">
                                    {feature.description}
                                </p>
