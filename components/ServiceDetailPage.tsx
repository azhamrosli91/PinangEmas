...
import { ArrowLeft, CheckCircle, ArrowRight, MessageCircle, ExternalLink } from 'lucide-react';
...
const ServiceDetailPage: React.FC<ServiceDetailPageProps> = ({ service, onBack, onNavigate }) => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-32 bg-[#FFFDF8] animate-in fade-in duration-700">
      {/* Cinematic Hero */}
      <div className="relative overflow-hidden py-24 md:py-40">
        <div className="absolute inset-0 gold-gradient opacity-[0.08] -z-10"></div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-2/3">
              ...
              <h1 className="text-5xl md:text-8xl font-black text-[#101010] mb-8 tracking-tighter leading-none">
              ...
              <p className="text-xl md:text-2xl text-[#101010]/70 leading-relaxed max-w-3xl mb-10">
      ...
      {service.pricing && !isHrms && (
        <div className="container mx-auto px-6 py-24 border-y border-[#AA771C]/10">
              ...
              <div key={i} className={`card-glass p-8 rounded-[2rem] flex flex-col h-full relative transition-all duration-500 hover:scale-[1.02] w-full max-w-sm mx-auto ${plan.isPopular ? 'border-[#AA771C]/50 shadow-[0_20px_45px_rgba(170,119,28,0.14)]' : ''}`}>
                ...
                <ul className="space-y-4 mb-8 flex-grow">
                  {plan.features?.map((f, j) => (
                    <li key={j} className="flex items-start text-[10px] text-[#101010]/75">
