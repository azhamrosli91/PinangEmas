...
import { Send, CheckCircle2, MessageCircle, MapPinOff, Globe } from 'lucide-react';
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 focus:border-[#AA771C] outline-none transition-colors appearance-none text-white">
