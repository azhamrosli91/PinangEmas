...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen transition-colors duration-500 overflow-x-hidden">
            ...
            <section className="py-16 bg-dark-surface border-y border-white/5 overflow-hidden">
              <div className="container mx-auto px-6">
                ...
                <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-20 hover:opacity-50 transition-opacity grayscale">
                   ...
                   <span className="text-2xl md:text-3xl font-black lowercase tracking-tight">quantum.it</span>
                   <span className="text-2xl md:text-3xl font-light uppercase tracking-tighter">Velocity Systems</span>
                   <span className="text-2xl md:text-3xl font-black tracking-[0.2em]">STARK</span>
                </div>
              </div>
            </section>
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-28 right-8 z-50 p-4 rounded-full gold-gradient text-black shadow-2xl transition-all duration-500 transform ${
